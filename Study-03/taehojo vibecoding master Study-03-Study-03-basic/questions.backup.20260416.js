// 백업 일시: 2026-04-16 | 문제 수: 50개 | 원본: questions.js
const quizQuestions = [
    // 한국사 (13문제)
    {
        id: 1,
    ...
    },
    {
        ...
        correctAnswer: 1,
        explanation: "나일강은 약 6,650km로 전통적으로 세계에서 가장 긴 강으로 알려져 있습니다. 단, 최근 일부 연구에서는 아마존강이 더 길 수 있다는 견해도 있어 학술적으로 논쟁 중입니다."
    },
    {
        id: 13,
        category: "세계지리",
    ...
    },
    {
        ...
        category: "세계지리",
        difficulty: "medium",
        question: "면적 기준으로 세계에서 가장 큰 사막은? (극지 사막 포함)",
        options: ["사하라 사막", "고비 사막", "남극 사막", "아라비아 사막"],
        correctAnswer: 2,
        explanation: "사막은 연 강수량 250mm 미만 지역으로 정의됩니다. 남극 대륙은 이 기준을 충족하는 극지 사막으로, 약 1,400만km²의 면적으로 세계 최대입니다. 열대 사막 기준으로는 사하라 사막(약 940만km²)이 가장 큽니다."
    },
    {
        id: 16,
        category: "세계지리",
    ...
    },
    {
        ...
        correctAnswer: 1,
        explanation: "에베레스트산은 해발 8,848.86m로 해발고도 기준 세계 최고봉입니다. 지구 중심에서의 거리 기준으로는 에콰도르의 침보라소산이 더 멀지만, 일반적으로 산의 높이는 해발고도로 측정합니다."
    },
    {
        id: 18,
        category: "세계지리",
        ...
        correctAnswer: 2,
        explanation: "카스피해는 약 371,000km²로 면적 기준 세계 최대의 호수입니다. 바이칼호는 담수량(세계 담수의 약 20%) 기준으로는 세계 최대입니다."
    },
    {
        id: 19,
        category: "세계지리",
    ...
    },
    {
        ...
        category: "세계지리",
        difficulty: "medium",
        question: "면적 기준으로 세계에서 가장 작은 나라는?",
    ...
    },
    {
        ...
        category: "과학",
        difficulty: "medium",
        question: "크기(부피) 기준으로 태양계에서 가장 큰 행성은?",
        options: ["토성", "목성", "천왕성", "해왕성"],
        correctAnswer: 1,
        explanation: "목성은 지름이 약 142,984km로 부피 및 질량 기준 태양계 최대 행성입니다."
    },
    {
        id: 23,
        category: "과학",
...
,
    ...
    },
    {
        ...
        category: "한국사",
        difficulty: "medium",
        question: "안중근 의사가 이토 히로부미를 저격한 연도는?",
        options: ["1905년", "1907년", "1909년", "1910년"],
        correctAnswer: 2,
        explanation: "안중근 의사는 1909년 10월 26일 중국 하얼빈 역에서 초대 조선 통감 이토 히로부미를 저격하였습니다."
    },
    {
        id: 50,
        category: "세계지리",
        difficulty: "hard",
        question: "길이 기준으로 세계에서 가장 긴 산맥은?",
        options: ["로키산맥", "히말라야산맥", "안데스산맥", "알프스산맥"],
        correctAnswer: 2,
        explanation: "안데스산맥은 남아메리카를 따라 약 7,000km에 걸쳐 뻗어 있어 길이 기준 세계에서 가장 긴 산맥입니다."
    }];
